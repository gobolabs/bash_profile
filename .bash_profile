...
alias composer-install-init="php bin/console composer install --noplugins"

#symfony-debug
alias routes="php bin/console debug:router"

#vagrant aliases
alias rsync-watcher="vagrant rsync-auto"
...
checkGitOnCurrentFolder () {
  if [ -d "$PWD/.git" ] 
  then
  	PS1="\[\033[01;31m\]\u\[\033[0;36m\] @ \[\033[0;36m\]\h \w\[\033[0;32m\] $(__git_ps1  "(%s)") \n\[\033[0;32m\]└─\[\033[0m\033[0;32m\] \$\[\033[0m\033[0;32m\] ▶\[\033[0m\] "
  else
    PS1='\[\033[01;31m\]\u\[\033[0;36m\] @ \[\033[0;36m\]\h \w\[\033[0;32m\] \n\[\033[0;32m\]└─\[\033[0m\033[0;32m\] \$\[\033[0m\033[0;32m\] ▶\[\033[0m\] '
  fi
}
